		...
		<div className="border-t border-b border-gray-300 text-center px-16 py-16 sm:py-20 lg:py-24 xl:py-32 flex items-center justify-center">
			<div>
				<Image
					...
					alt={"Parece que você se perdeu"}
					width={822}
					height={492}
				/>

				<Text variant="mediumHeading">{"Parece que você se perdeu"}</Text>
				<p className="text-sm md:text-base leading-7 pt-2 md:pt-3.5 pb-7 md:pb-9">
					{"Não conseguimos achar a pagina que voce queria"}
				</p>
				<Link
					href="/"
				...
				>
					<IoHomeSharp />
					<span className="ps-1.5">{"Ir para Página Principal"}</span>
				</Link>
			</div>
		</div>
	);
