...
export const homeThreeMasonryBanner = [
    {
        id: 1,
        title: "Ignite",
        slug: "/search?q=ignite",
        image: {
            mobile: {
                url: "/assets/images/banner_vapo/combos.jpg",
                width: 470,
                height: 232,
            },
            desktop: {
    ...
    },
    {
        ...
        image: {
            mobile: {
                url: "/assets/images/banner_vapo/tabacaria.jpg",
                width: 470,
                height: 232,
            },
            desktop: {
